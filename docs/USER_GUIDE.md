...
# 登录风险控制（可选）
ALLOWED_LOGIN_REGIONS=cn,beijing
BLOCKED_LOGIN_REGIONS=
LOGIN_RISK_WINDOW_HOURS=6
RISK_MFA_ENABLED=true
...
_使用指南版本: 1.0.1 | 最后更新: 2026-02-01_
