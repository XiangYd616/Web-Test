...
- [前后端接口对齐清单](API_ALIGNMENT.md) - 前端服务与后端路由对齐结果
- [数据库配置指南](DATABASE_COMPLETE_GUIDE.md) - DB\_ 环境变量与初始化说明
- [测试结果Schema](TEST_RESULT_SCHEMA.md) - 引擎统一输出结构
- [OAuth配置指南](OAUTH_SETUP.md) - 第三方登录配置说明
- [贡献指南](CONTRIBUTING.md) - 如何参与项目开发

### 运维部署

- [部署指南](DEPLOYMENT.md) - 生产环境部署
- [可观测性与日志](OBSERVABILITY.md) - 监控、日志与告警说明
...
> 统一架构说明已合并至 ARCHITECTURE_STANDARDS.md
...
> API 细节请以 `/api/docs` Swagger 页面为准
...
2. 按照 [PROJECT_STARTUP_GUIDE.md](PROJECT_STARTUP_GUIDE.md) 搭建环境
