...
const LazySettings = lazy(() => import('../pages/core/settings/Settings')); // 测试相关页面;
...
const LazySecurityTest = lazy(() => import('../pages/core/testing/SecurityTest')); // 管理页面;
...
const LazyUserManagement = lazy(() => import('../pages/core/management/UserManagement')); // 报告页面;
