import { Activity, AlertCircle, CheckCircle, Pause, Play, XCircle    } from 'lucide-react';import React from 'react';// 测试状态类型 - 简化版本'
export type TestStatus   = 'idle' | 'starting' | 'running' | 'completed' | 'cancelled' | 'failed';// 状态配置接口'
