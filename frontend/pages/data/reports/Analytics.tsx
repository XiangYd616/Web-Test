...
// import { analyticsService as AdvancedAnalyticsService } from '../../../../backend/services/redis/analytics.js'; // 前端不应该直接导入后端文件
...
const Analytics: React.FC = () => {
  ...
  return (
    <div className="data-management-container space-y-6">
      <div className="data-management-wrapper">
        ...
        {/* 页面标题和控制 */}
        <div className="data-page-header bg-gradient-to-r from-blue-600/20 to-indigo-600/20 border border-blue-500/30 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="data-page-title text-white font-bold mb-2">高级分析</h1>
              <p className="data-page-subtitle text-gray-300">基于 AI 的深度分析，提供智能洞察和优化建议</p>
