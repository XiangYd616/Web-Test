import React, { useState, useEffect    } from 'react';import { useState, useEffect    } from 'react';import { useAsyncErrorHandler    } from '../hooks/useAsyncErrorHandler';import { BarChart3, TrendingUp, Users, Globe, Clock, AlertCircle    } from 'lucide-react';import { Line, Bar, Doughnut    } from 'react-chartjs-2';import { Chart as ChartJS, CategoryScale, LinearScale, PointElement, LineElement, BarElement, Title, Tooltip, Legend, // ArcElement,    } from 'chart.js';// 已修复'
ChartJS.register(
  CategoryScale,
  LinearScale,
  PointElement,
