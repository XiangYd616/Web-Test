import React, { useState, useEffect    } from 'react';import { useState, useEffect    } from 'react';import { useAsyncErrorHandler    } from '../hooks/useAsyncErrorHandler';import { FileText, Download, Filter, Search, BarChart3, PieChart, TrendingUp, Users, Globe, Shield, Zap    } from 'lucide-react';interface ReportData   {'
  id: string;
  name: string;
                ...
                {filteredReports.map((report) => (
                  <tr key={report.id} className= 'hover:bg-gray-700'>
                    ...
                    <td className= 'px-6 py-4 whitespace-nowrap text-sm font-medium'>
                      {report.status === 'completed' && report.downloadUrl ? (<button'
