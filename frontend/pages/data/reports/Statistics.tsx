import React, { useEffect, useState    } from 'react';import { Activity, BarChart3, Calendar, PieChart, TrendingUp    } from 'lucide-react';interface StatisticsData   {'
  overview: {
    totalTests: number;
...
const Statistics: React.FC  = () => {
  ...
  return (<div className= 'data-management-container'>
