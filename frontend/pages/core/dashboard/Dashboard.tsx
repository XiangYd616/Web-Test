import { Activity, AlertTriangle, BarChart3, CheckCircle, Clock, Download, Globe, TestTube    } from 'lucide-react';import React, { useEffect, useState    } from 'react';import { DoughnutChart, LineChart    } from '../../../components/charts/Chart.tsx';import { useTheme    } from '../../../contexts/ThemeContext.tsx';// CSS样式已迁移到组件库和主题配置中'
const Dashboard: React.FC  = () => {
  ...
  return (<div className={`min-h-screen p-6 ${actualTheme === 'light' ? 'bg-gray-100' : "bg-gray-900'}`}>`
