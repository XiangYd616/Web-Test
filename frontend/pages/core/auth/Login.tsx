import { AlertCircle, Eye, EyeOff, Lock, Mail, Moon, Sun    } from 'lucide-react';import React, { useState    } from 'react';import { Link, useNavigate    } from 'react-router-dom';import { useAuth    } from '../../../contexts/AuthContext.tsx';import { useTheme    } from '../../../contexts/ThemeContext.tsx';import { useAsyncErrorHandler    } from '../../../hooks/useAsyncErrorHandler';const Login: React.FC  = () => {'
  // 页面级功能
  ...
  // 增强的登录处理方法
  const handleLoginWithAuth = async (credentials: any) => {
