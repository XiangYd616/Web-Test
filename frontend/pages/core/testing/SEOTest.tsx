import { AlertCircle, CheckCircle, Clock, Eye, FileText, Globe, HardDrive, Image, Link, Loader, MapPin, Search, Settings, Share2, Smartphone, Square, XCircle, Zap    } from 'lucide-react';import { useState, useEffect    } from 'react';import { useAsyncErrorHandler    } from '../hooks/useAsyncErrorHandler';import TestResults from '../components/TestResults';import React, { useEffect, useState    } from 'react';import { useAuthCheck    } from '../../../components/auth/WithAuthCheck.tsx';import BaseTestPage from '../../../components/testing/BaseTestPage.tsx';import FileUploadSEO from '../../../components/testing/FileUploadSEO.tsx';import LocalSEOResults from '../../../components/testing/LocalSEOResults.tsx';import NetworkErrorPrompt from '../../../components/testing/NetworkErrorPrompt.tsx';import SEOResults from '../../../components/testing/SEOResults.tsx';import URLInput from '../../../components/testing/URLInput';import type { SEOTestMode  } from '../../../hooks/useSEOTest';import { useUnifiedSEOTest    } from '../../../hooks/useSEOTest';// CSS样式已迁移到组件库中'
  ...
  return (<BaseTestPage
      ...
      testContent={
        <div className= 'space-y-6'>
              ...
              <div>
                ...
                <div className= 'flex items-center space-x-2'>
                  ...
                  <div className= 'flex items-center space-x-2'>
                    ...
                    {/* 完成状态操作按钮 - 独立区域 */}
                    {testStatus === 'completed' && (<div className= 'flex items-center space-x-2'>
                        <button
                          type= 'button';
                          onClick={() => {
                            setError('');'
          ...
          <div className= 'bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
            <div className= 'space-y-4'>
              {seoTestMode === 'online' ? (<div className= 'url-input-form-group'>
