...
import { Shield    } from 'lucide-react';import React, { useEffect    } from 'react';interface SecurityTestConfig   {'
  url: string;
...
const SecurityTest: React.FC  = () => {
  ...
  const renderResults = () => {
    ...
    if (result) {
        ...
        <div className= 'space-y-6'>
          ...
          {/* 漏洞详情 */}
          {result.vulnerabilities.length > 0 && (<div className= 'bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
          ...
          {/* 改进建议 */}
          {result.recommendations.length > 0 && (<div className= 'bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
              <h3 className= 'text-lg font-semibold mb-4 text-gray-900 dark:text-white'>
                改进建议
              </h3>
  ...
  return (<div className= 'security-test-page max-w-6xl mx-auto p-6'>
      <div className= 'mb-6'>
