import { AlertTriangle, CheckCircle, Clock, Code, Download, Eye, Gauge, Globe, Loader, Lock, Play, RotateCcw, Search, Share2, Shield, Square, XCircle    } from 'lucide-react';import { useState, useEffect    } from 'react';import { useAsyncErrorHandler    } from '../hooks/useAsyncErrorHandler';import TestResults from '../components/TestResults';import React, { useEffect, useState    } from 'react';import { useSearchParams    } from 'react-router-dom';import { useAuthCheck    } from '../../../components/auth/WithAuthCheck.tsx';// // import TestCharts - 文件已删除'
// 文件已删除;
import BaseTestPage from '../../../components/testing/BaseTestPage.tsx';import URLInput from '../../../components/testing/URLInput';import { ProgressBar    } from '../../../components/ui/ProgressBar.tsx';import { useUserStats    } from '../../../hooks/useUserStats.ts';// CSS样式已迁移到组件库中'
            ...
            <div className= 'lg:col-span-2 space-y-6'>
              ...
              <div className= 'bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
                ...
                <div className= 'space-y-4'>
                  ...
                  {/* 性能测试级别 */}
                  {config.testTypes.performance && (<div>
