...
import React from 'react';import { TestType    } from '../../../types/testConfig';import { TestPage    } from '../TestPage';const CompatibilityTest: React.FC  = () => {'
  // 页面级功能
              ...
              <div className= 'bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
                ...
                <div className= 'space-y-4'>
                  ...
                  <div>
                    ...
                    {/* 可访问性详细选项 */}
                    {config.checkAccessibility && (<div className= 'ml-6 space-y-2 border-l-2 border-gray-600 pl-4'>
                        <label className= 'flex items-center'>
                          <input
                            type= 'checkbox';
                      ...
                      <div className= 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                        {Object.entries((results as any)?.browserCompatibility || {}).map(([browser, score]) => (
                          <div key={browser} className= 'bg-gray-700/50 rounded-lg p-4'>
                            ...
                            <ProgressBar value={Math.max(0, Math.min(100, Number(score)))}
