...
const Help: React.FC  = () => {
  ...
  return (<div className= 'space-y-6'>
      ...
      <div className= 'space-y-6'>
        {/* 快速指南标签页 */}
        {activeTab === 'guides' && (<div className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
        ...
        {/* 常见问题标签页 */}
        {activeTab === 'faq' && (<div className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
            <div className= 'flex items-center justify-between mb-6'>
              <div className= 'flex items-center'>
            ...
            <div className= 'space-y-4'>
              {filteredFAQs.map((faq) => (
                ...
                >
                  ...
                  {expandedFAQ === faq.id && (<div className= "px-4 pb-4 border-t border-gray-600/30 bg-gray-700/10'>`
        ...
        {/* 视频教程标签页 */}
        {activeTab === 'videos' && (<div className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
        ...
        {/* 下载资源标签页 */}
        {activeTab === 'downloads' && (<div className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
            <div className= 'flex items-center mb-6'>
        ...
        {/* 联系支持标签页 */}
        {activeTab === 'contact' && (<div className= 'grid grid-cols-1 lg:grid-cols-2 gap-6'>
            {/* 联系方式 */}
            <div className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>
              <div className= 'flex items-center mb-6'>
