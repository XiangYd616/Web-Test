import React, { useEffect    } from 'react';import { Copy, Key, Zap, Globe, BarChart3, CheckCircle, AlertTriangle, Play, Download, Github    } from 'lucide-react';interface APIEndpoint   {'
      ...
      <div className= 'grid grid-cols-1 lg:grid-cols-4 gap-8'>
        ...
        <div className= 'lg:col-span-3'>
          <div className= 'bg-white rounded-xl shadow-sm border border-gray-200'>
            {/* 快速开始 */}
            {activeSection === 'getting-started' && (<div className= 'p-8'>
...
{`{`
  ...
  'error': {'
    ...
    'message': 'Invalid API key';
            ...
            {/* API端点 */}
            {(activeSection === "performance' || activeSection === 'monitoring') && (<div className= 'p-8'>`
                ...
                <div className= 'space-y-8'>
                  {apiEndpoints[activeSection]?.map((endpoint, index) => (
                    <div key={index} className= 'border border-gray-200 rounded-lg'>
                      ...
                      <div className= 'p-6'>
                        {/* 参数 */}
                        {endpoint.parameters && (<div className= 'mb-6'>
            ...
            {/* SDK下载 */}
            {activeSection === 'sdks' && (<div className= 'p-8'>
