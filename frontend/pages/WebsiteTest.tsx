          ...
          const websiteResult: WebsiteTestResult = {
            ...
            testResults: {
              performance: config.includePerformance
                ? {
                    score:
                      result.testResults?.performance?.score ||
                      result.data?.performance?.score ||
                      85,
                    metrics: {
                      loadTime: result.testResults?.performance?.metrics?.loadTime || 1200,
                      firstContentfulPaint:
                        result.testResults?.performance?.metrics?.firstContentfulPaint || 800,
                      largestContentfulPaint:
                        result.testResults?.performance?.metrics?.largestContentfulPaint || 1500,
                      cumulativeLayoutShift:
                        result.testResults?.performance?.metrics?.cumulativeLayoutShift || 0.1,
                      timeToInteractive:
                        result.testResults?.performance?.metrics?.timeToInteractive || 2000,
                    },
                  }
                : undefined,
              security: config.includeSecurity
                ? {
                    score:
                      result.testResults?.security?.score || result.data?.security?.score || 90,
                    ...
                    certificates: {
                      ...
                      expiryDate:
                        result.testResults?.security?.certificates?.expiryDate || '2025-12-31',
              ...
              accessibility: config.includeAccessibility
                ? {
                    score:
                      result.testResults?.accessibility?.score ||
              ...
              compatibility: config.includeCompatibility
                ? {
                    score:
                      result.testResults?.compatibility?.score ||
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-lg border border-gray-700/50 shadow-xl p-6">
            <h3 className="text-lg font-semibold text-white mb-4 flex items-center justify-between">
              ...
              {/* 测试套件选择 */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">测试套件</label>
              ...
              {/* 测试项目选择 */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-3">测试项目</label>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {[
                    ...
                    <label
                      key={test.key}
                      className="flex items-start space-x-3 p-3 themed-border-primary border rounded-lg hover:themed-bg-secondary transition-colors cursor-pointer"
                    >
                      <input
                        type="checkbox"
                        checked={config[test.key as keyof WebsiteConfig] as boolean}
                        onChange={e =>
                          handleConfigChange(test.key as keyof WebsiteConfig, e?.target.checked)
                        }
                  ...
                  {result.testResults.performance && (
                    <div className="bg-blue-50 rounded-lg p-4">
                      ...
                      <div className="text-lg font-semibold text-blue-900">
                        {result.testResults.performance?.score}/100
                      </div>
                  ...
                  {result.testResults.security && (
                    <div className="bg-green-50 rounded-lg p-4">
                      ...
                      <div className="text-lg font-semibold text-green-900">
                        {result.testResults.security?.score}/100
                      </div>
                  ...
                  {result.testResults.seo && (
                    <div className="bg-purple-50 rounded-lg p-4">
                      ...
                      <div className="text-lg font-semibold text-purple-900">
                        {result.testResults.seo?.score}/100
                      </div>
                  ...
                  {result.testResults.accessibility && (
                    <div className="bg-orange-50 rounded-lg p-4">
                      ...
                      <div className="text-lg font-semibold text-orange-900">
                        {result.testResults.accessibility?.score}/100
                      </div>
                  ...
                  {result.testResults.compatibility && (
                    <div className="bg-indigo-50 rounded-lg p-4">
                      ...
                      <div className="text-lg font-semibold text-indigo-900">
                        {result.testResults.compatibility?.score}/100
                      </div>
                      <div className="text-xs text-indigo-600 mt-1">
                        {
                          result.testResults.compatibility?.browserSupport.filter(b => b.supported)
                            .length
                        }{' '}
                        个浏览器支持
                      </div>
                  ...
                  {result.testResults.ux && (
                    <div className="bg-pink-50 rounded-lg p-4">
                      ...
                      <div className="text-lg font-semibold text-pink-900">
                        {result.testResults.ux?.score}/100
                      </div>
