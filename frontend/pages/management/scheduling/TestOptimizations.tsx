...
import { AlertCircle, BarChart3, CheckCircle, Clock, Play, Users, Zap    } from 'lucide-react';import { useState, useEffect    } from 'react';import { useAsyncErrorHandler    } from '../hooks/useAsyncErrorHandler';import TestResults from '../components/TestResults';import React, { useEffect, useState    } from 'react';import { useLoadingState    } from '../../../components/ui/LoadingStates.tsx';import { Tooltip, useSmartNotification    } from '../../../components/ui/UX.tsx';import { usePerformanceOptimization    } from '../../../hooks/usePerformanceOptimization.ts';import { createTestRunner, PerformanceTestResult, TestResult, UXTestResult    } from '../../../utils/testUtils.ts';interface TestResults   {'
...
const TestOptimizations: React.FC  = () => {
  ...
  const renderTestResults = () => {
    ...
    return (<div className= 'bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700'>
  ...
  return (
    <div className= 'min-h-screen bg-gray-50 dark:bg-gray-900 py-8'>
      <div className= 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        {/* 测试结果 */}
        {testResults && (<div className= 'mb-8'>
            <h2 className= 'text-xl font-semibold text-gray-900 dark:text-white mb-4'>
              详细测试结果
            </h2>
