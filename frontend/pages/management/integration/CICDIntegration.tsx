import React, { useEffect    } from 'react';import { AlertTriangle, Book, CheckCircle, Clock, Code, Copy, Download, ExternalLink, GitBranch, Globe, Key, Layers, Play, Settings, Shield, Terminal, Webhook, Zap    } from 'lucide-react';const CICDIntegration: React.FC  = () => {'
  // 页面级功能
...
test_website: undefined, // 已修复
  ...
  return (<div className= 'min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6 space-y-6'>
      ...
      <div className= 'bg-gray-800/50 rounded-xl shadow-lg p-6 border border-gray-700 backdrop-blur-sm'>
        ...
        {/* GitHub Actions 配置 */}
        {activeTab === 'github' && (<div className= 'space-y-6'>
        ...
        {/* GitLab CI 配置 */}
        {activeTab === 'gitlab' && (<div className= 'space-y-6'>
            <div className= 'bg-gray-700/20 rounded-lg p-6 border border-gray-600/30'>
              <div className= 'flex items-center justify-between mb-4'>
                <div className= 'flex items-center space-x-3'>
