import { Activity, AlertTriangle, CheckCircle, Edit, ExternalLink, Filter, Globe, Pause, Play, Plus, RefreshCw, Search, Send, Shield, Trash2, Webhook, XCircle    } from 'lucide-react';import React, { useEffect, useState    } from 'react';import IntegrationService, { WebhookConfig  } from '../../../services/integration/integrationService.ts';interface WebhooksProps  { }'
  ...
  return (<div className= 'min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6 space-y-6'>
      ...
      <div className= 'bg-gray-800/50 rounded-xl shadow-lg border border-gray-700 backdrop-blur-sm'>
        ...
        <div className= 'divide-y divide-gray-700'>
          ...
          {filteredWebhooks.length === 0 && (<div className= 'p-12 text-center'>
