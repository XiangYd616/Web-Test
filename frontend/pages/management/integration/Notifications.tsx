import { AlertTriangle, Bell, Check, CheckCircle, ExternalLink, Info, RefreshCw, Search, Trash2, X    } from 'lucide-react';import React, { useEffect    } from 'react';import { Link    } from 'react-router-dom';import { NotificationItem, useNotifications    } from '../../../hooks/useNotifications.ts';const Notifications: React.FC  = () => {'
  // 页面级功能
  ...
  return (<div className= 'space-y-6 dark-page-scrollbar'>
      {/* 页面标题 */}
