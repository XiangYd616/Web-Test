import React, { useEffect, useState    } from 'react';import { Activity, AlertTriangle, BarChart3, Copy, Edit, Eye, EyeOff, Globe, Key, Package, Plus, RefreshCw, Trash2, Webhook, Zap    } from 'lucide-react';import IntegrationService, { APIKey,'
  IntegrationStats,
...
const Integrations: React.FC<IntegrationsProps>  = () => {
  ...
  return (<div className= 'min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6 space-y-6'>
      ...
      {/* API密钥标签页 */}
      {activeTab === 'api-keys' && (<div className= 'space-y-6'>
          {/* API密钥列表头部 */}
          <div className= 'bg-gray-800/50 rounded-xl shadow-lg p-6 border border-gray-700 backdrop-blur-sm'>
            <div className= 'flex items-center justify-between mb-4'>
      ...
      {/* Webhooks标签页 */}
      {activeTab === 'webhooks' && (<div className= 'space-y-6'>
          {/* Webhooks列表头部 */}
          <div className= 'bg-gray-800/50 rounded-xl shadow-lg p-6 border border-gray-700 backdrop-blur-sm'>
            <div className= 'flex items-center justify-between mb-4'>
              <h3 className= 'text-lg font-semibold text-white flex items-center gap-2'>
      ...
      {/* 第三方集成标签页 */}
      {activeTab === 'third-party' && (<div className= 'space-y-6'>
          <div className= 'bg-gray-800/50 rounded-xl shadow-lg p-6 border border-gray-700 backdrop-blur-sm'>
            <h3 className= 'text-lg font-semibold text-white mb-4 flex items-center gap-2'>
              <Globe className= 'w-5 h-5 text-purple-400'    />
              第三方服务集成
