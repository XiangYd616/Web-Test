import { Activity, AlertTriangle, CheckCircle, Clock, Copy, Edit, Eye, EyeOff, Filter, Key, Plus, RefreshCw, Search, Shield, Trash2    } from 'lucide-react';import React, { useEffect, useState    } from 'react';import IntegrationService, { APIKey  } from '../../../services/integration/integrationService.ts';interface APIKeysProps  { }'
const APIKeys: React.FC<APIKeysProps>  = () => {
  ...
  return (<div className= 'min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6 space-y-6'>
      {/* 页面标题 */}
      ...
      <div className= 'bg-gray-800/50 rounded-xl shadow-lg border border-gray-700 backdrop-blur-sm'>
        ...
        <div className= 'divide-y divide-gray-700'>
          ...
          {filteredAPIKeys.length === 0 && (<div className= 'p-12 text-center'>
      ...
      {/* 创建API密钥模态框 */}
      {showCreateModal && (<div className= 'fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50'>
