...
class UserService {
  ...
  async getProfile(): Promise<UserProfile> {
    try {
      const response = await apiService.apiGet('/user/profile');
      if (response.success) {
  ...
  async updateProfile(data: UpdateProfileData): Promise<UserProfile> {
    try {
      const response = await apiService.apiPut('/user/profile', data);
      if (response.success) {
        return response.data.user;
      }
  ...
  async getUserStats(): Promise<UserStats> {
    try {
      const response = await apiService.apiGet('/user/stats');
      if (response.success) {
  ...
  async getSettings(): Promise<UserSettings> {
    try {
      const response = await apiService.apiGet('/user/settings');
      if (response.success) {
  ...
  async updateSettings(settings: Partial<UserSettings>): Promise<UserSettings> {
    try {
      const response = await apiService.apiPut('/user/settings', { settings });
      if (response.success) {
        return response.data.settings;
      }
  ...
  async uploadAvatar(file: File): Promise<string> {
    try {
      ...
      const response = await apiService.apiPost('/user/avatar', formData, {
        headers: {
  ...
  async deleteAvatar(): Promise<void> {
    try {
      const response = await apiService.apiDelete('/user/avatar');
      if (!response.success) {
  ...
  async changePassword(data: ChangePasswordData): Promise<void> {
    try {
      const response = await apiService.apiPut('/user/password', data);
      if (!response.success) {
  ...
  async getBookmarks(): Promise<BookmarkItem[]> {
    try {
      const response = await apiService.apiGet('/user/bookmarks');
      if (response.success) {
  ...
  async addBookmark(bookmark: Omit<BookmarkItem, 'id' | 'createdAt' | 'visitCount'>): Promise<BookmarkItem> {
    try {
      const response = await apiService.apiPost('/user/bookmarks', bookmark);
      if (response.success) {
  ...
  async updateBookmark(id: string, updates: Partial<BookmarkItem>): Promise<BookmarkItem> {
    try {
      const response = await apiService.apiPut(`/user/bookmarks/${id}`, updates);
      if (response.success) {
        return response.data.bookmark;
      }
  ...
  async deleteBookmark(id: string): Promise<void> {
    try {
      const response = await apiService.delete(`/user/bookmarks/${id}`);
      if (!response.success) {
  ...
  async getTestHistory(page = 1, limit = 20): Promise<{ tests: unknown[], total: number, page: number, totalPages: number }> {
    try {
      const response = await apiService.get(`/user/tests?page=${page}&limit=${limit}`);
      if (response.success) {
        return response.data;
      }
  ...
  async deleteTestResult(id: string): Promise<void> {
    try {
      const response = await apiService.delete(`/user/tests/${id}`);
      if (!response.success) {
  ...
  async getNotifications(page = 1, limit = 20): Promise<{ notifications: unknown[], total: number, unreadCount: number }> {
    try {
      const response = await apiService.get(`/user/notifications?page=${page}&limit=${limit}`);
      if (response.success) {
        return response.data;
      }
  ...
  async markNotificationAsRead(id: string): Promise<void> {
    try {
      const response = await apiService.put(`/user/notifications/${id}/read`);
      if (!response.success) {
