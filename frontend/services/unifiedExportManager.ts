...
// 创建单例实例
export const unifiedExportManager = new UnifiedExportManager();
...
export const useExportManager = () => {
  ...
  return {
    ...
    downloadExport: unifiedExportManager.downloadExport.bind(unifiedExportManager),
    cleanup: unifiedExportManager.cleanupCompletedTasks.bind(unifiedExportManager)
  };
};
