/**
 * API Service Types - Legacy File (Deprecated)
 * 
...
/*
 * Original content has been moved to types/api/index.ts
 * This file now serves as a legacy wrapper for backward compatibility.
 */
