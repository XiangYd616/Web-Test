...
import React from 'react';import { AlertTriangle, BarChart3, CheckCircle, Clock, TrendingDown, TrendingUp, Users, Zap    } from 'lucide-react';interface StressTestMetricsType   {'
...
export const StressTestMetrics: React.FC<StressTestMetricsProps> = ({
  ...
  return (<div className={className}>
      ...
      {/* 高级指标（如果有） */}
      {advancedMetrics.length > 0 && (<div className= 'grid grid-cols-2 md:grid-cols-4 gap-4 mb-4'>
