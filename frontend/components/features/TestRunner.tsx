...
import { Download, History, Play, RefreshCw, Settings, Square    } from 'lucide-react';import React, { useCallback, useEffect, useState    } from 'react';import { useNotification    } from '../../hooks/useNotification';import { useTestEngine    } from '../../hooks/useTestEngine';import { Badge, Button, Card, Input, Loading, Modal, ProgressBar, Select, // type SelectOption   } from '../ui/index';// 已修复'
// 测试类型定义
export type TestType   = 'api' | 'compatibility' | 'infrastructure' | 'security' | 'seo' | 'stress' | 'ux' | "website';// 测试配置接口'
  ...
  const ariaProps = {
    ...
    const renderConfigForm = () => (
        <div className= 'space-y-4'>
            ...
            {/* 根据测试类型显示特定配置 */}
            {testType === 'stress' && (<div className= 'grid grid-cols-2 gap-4'>
                    <Input
                        label= '并发用户数';
                        type= 'number';
            ...
            {testType === 'security' && (<div className= 'space-y-3'>
        ...
        <Card className= 'p-6'>
            <div className= 'flex items-start justify-between mb-4'>
                ...
                <div className= 'flex items-center space-x-2'>
                    {result.status === 'completed' && (<Button'
                            size= 'sm';
                            variant= 'outline';
    ...
    return (<div className={`space-y-6 ${className}`}>`
            ...
            >
                <div className= 'space-y-4 max-h-96 overflow-y-auto'>
                    {testHistory.length === 0 ? (<div className= 'text-center py-8'>
