...
import React, { useMemo, useState    } from 'react';import { Badge, Button, Card, Input, Modal, Select, // Table   } from '../ui/index';// 已修复'
// SelectOption and TableColumn types will be defined locally
import { TestResult    } from './TestRunner';// 结果详情接口'
  ...
  const ariaProps = {
    ...
    const renderDetails = () => (
        <div className= 'space-y-6'>
            ...
            {/* 图表展示 */}
            {details?.charts && details.charts.length > 0 && (<Card className= 'p-6'>
            ...
            {/* 原始数据 */}
            {details?.rawData && (<Card className= 'p-6'>
            ...
            <Card className= "p-6'>`
                <div className= 'flex items-center justify-between'>
                    ...
                    <div className= 'flex items-center space-x-3'>
                        ...
                        {onDownload && (<div className= 'flex items-center space-x-1'>
                                <Button
                                    variant= 'ghost';
