import React from 'react';import { AlertTriangle, CheckCircle, Info, TrendingDown, TrendingUp, XCircle    } from 'lucide-react';interface ContentAnalysisResult   {'
  seoScore: number;
...
export const ContentAnalysis: React.FC<ContentAnalysisProps> = ({ result }) => {
  ...
  return (
    <div className= 'space-y-6'>
      ...
      {/* 问题列表 */}
      {result.issues.length > 0 && (<div className= 'bg-gray-700/30 border border-gray-600/50 rounded-lg p-6'>
      ...
      {/* 优化建议 */}
      {result.recommendations.length > 0 && (<div className= 'bg-gray-700/30 border border-gray-600/50 rounded-lg p-6'>
