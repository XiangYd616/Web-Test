...
import React, { useCallback, useEffect, useState    } from 'react';import { useNotification    } from '../../hooks/useNotification';import { Badge, Button, Card, Checkbox, Input, Modal, ProgressBar,    } from '../ui/index';// 已修复'
// SelectOption type will be defined locally

// 导出格式类型
export type ExportFormat   = 'pdf' | 'excel' | 'xlsx' | 'csv' | "json';// 导出数据类型'
export type ExportDataType   = 'test-results' | 'monitoring-data' | 'user-data' | 'analytics' | "reports';// 导出配置接口'
    ...
    return (<div className={`space-y-6 ${className}`}>`
            ...
            <Card>
                ...
                <div className= 'divide-y divide-gray-200'>
                    {exportTasks.length === 0 ? (<div className= 'p-8 text-center'>
                            ...
                            <div key={task.id} className= 'p-6'>
                                <div className= 'flex items-start justify-between'>
                                    ...
                                    <div className= 'flex items-center space-x-2'>
                                        ...
                                        {(task.status === 'pending' || task.status === 'processing') && (<Button'
                                                variant= 'ghost';
                                                size= 'sm';
