import { AlertCircle, AlertTriangle, CheckCircle, Eye, Info, Lock, Shield, TrendingDown, TrendingUp, XCircle    } from 'lucide-react';import React from 'react';interface SecurityAnalysisResult   {'
...
export const SecurityAnalysis: React.FC<SecurityAnalysisProps> = ({ result }) => {
  ...
  return (
    <div className= 'space-y-6'>
      ...
      {/* 发现的漏洞 */}
      {result.vulnerabilities.length > 0 && (<div className= 'bg-gray-800/50 border border-gray-700/50 rounded-lg p-6'>
      ...
      {/* 安全建议 */}
      {result.recommendations.length > 0 && (<div className= 'bg-gray-800/50 border border-gray-700/50 rounded-lg p-6'>
