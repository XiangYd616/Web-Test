import React, { useState    } from 'react';import { ChevronDown, Filter, RefreshCw, Search    } from 'lucide-react';import { FilterOptions    } from '../../hooks/useDataStorage.ts';interface DataFiltersProps   {'
...
const DataFilters: React.FC<DataFiltersProps>  = ({
  ...
  return (<section className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6' aria-label= '数据过滤器'>
      {/* 基础过滤器 */}
      ...
      {/* 高级过滤器 */}
      {showAdvanced && (<fieldset id= 'advanced-filters' className= 'border-t border-gray-700/50 pt-4'>
