...
export interface GridItemProps
  extends Omit<MuiGridProps, 'container' | 'item' | 'xs' | 'sm' | 'md' | 'lg' | 'xl'> {
  children: React.ReactNode;
  // 响应式尺寸
...
export const GridItem: React.FC<GridItemProps> = ({ children, xs, sm, md, lg, xl, ...props }) => {
  return (
    <MuiGrid {...props} size={{ xs, sm, md, lg, xl } as any}>
      {children}
    </MuiGrid>
  );
};
