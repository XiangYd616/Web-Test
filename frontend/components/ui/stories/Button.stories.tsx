...
import { action    } from '@storybook/addon-actions';import type { Meta, StoryObj  } from '@storybook/react';import { Download, Play, Plus, Settings, Trash2    } from 'lucide-react';import { ThemeProvider    } from '../../../contexts/ThemeContext';import { Button, DeleteButton, GhostButton, IconButton, OutlineButton, PrimaryButton, SecondaryButton    } from '../Button';export interface Button.storiesProps     {'
  // 基础属性
  className?: string;
