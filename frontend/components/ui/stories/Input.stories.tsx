...
import { action    } from '@storybook/addon-actions';import type { Meta, StoryObj  } from '@storybook/react';import { Lock, Mail, Phone, Search, User    } from 'lucide-react';import { ThemeProvider    } from '../../../contexts/ThemeContext';import { Input, NumberInput, PasswordInput, SearchInput, Select, Textarea    } from '../Input';export interface Input.storiesProps     {'
  // 基础属性
  className?: string;
