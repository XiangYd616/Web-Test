...
import { BarChart3, Calendar, Eye, MoreHorizontal, RefreshCw, Search, Star    } from 'lucide-react';import React, { useCallback, useEffect, useState    } from 'react';import { useNavigate    } from 'react-router-dom';import { useAuth    } from '../../contexts/AuthContext';interface TestRecord   {'
  id: string;
  testName: string;
  url: string;
...
export const TestPageHistory: React.FC<TestPageHistoryProps> = ({
  ...
  return (<div className={`test-page-history bg-gray-800/30 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/40 dark:border-gray-600/30 shadow-lg ${className}`}>`
      {/* 头部 */}
