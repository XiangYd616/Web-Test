...
// 点状态指示器;
interface DotBadgeProps extends React.HTMLAttributes<HTMLSpanElement>   {  status: 'success' | 'error' | 'warning' | 'pending' | 'info`;
  size?: 'sm' | 'md' | 'lg;
  pulse?: boolean}`;
const dotColors = {`;
