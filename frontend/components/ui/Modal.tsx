...
export const Modal: React.FC<ModalProps> = ({
  ...
  const previousFocusRef = useRef<HTMLElement | null>(null); // 处理ESC键关闭
  useEffect(() => {
...
}, [isOpen, closeOnEscape, onClose]); // 焦点管理
  useEffect(() => {
    if (isOpen) {
      // 保存当前焦点元素
      previousFocusRef.current = document.activeElement as HTMLElement; // 聚焦到模态框
      setTimeout(() => {
