import React from 'react';import { Download, Play, RotateCcw, Settings, Share2, Square    } from 'lucide-react';import { cn    } from '../../utils/cn';import { Button    } from './Button';interface TestingToolbarProps   {'
  /** 是否正在运行测试 */
  isRunning?: boolean;
  /** 是否可以开始测试 */
  canStart?: boolean;
...
export const TestProgress: React.FC<TestProgressProps> = ({
  ...
  return (
    <div className={cn("space-y-3', className)}>
      ...
      {/* 步骤详情 */}
      {showDetails && steps.length > 0 && (<div className= "space-y-2'>`
...
export const TestResultSummary: React.FC<TestResultSummaryProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 指标 */}
      {metrics.length > 0 && (<div className= 'grid grid-cols-2 md:grid-cols-3 gap-3'>
