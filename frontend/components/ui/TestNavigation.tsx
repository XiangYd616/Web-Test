import React from 'react';import { Card, CardHeader, CardTitle, CardBody    } from './Card';import { Button    } from './Button';import { Badge, StatusBadge    } from './Badge';import { Layout, Square, Type, Award, Layers, ExternalLink, CheckCircle    } from 'lucide-react';export interface TestNavigationProps     {'
  // 基础属性
  className?: string;
...
export const TestNavigation: React.FC<TestNavigationProps> = (props) => {
  ...
  return (<div className= 'p-8 space-y-8 bg-gray-900 min-h-screen'>
              ...
              return (<Card key={page.id} hover>
                  <CardHeader>
                    <div className= 'flex items-center justify-between'>
                      ...
                      <StatusBadge status={page.status === 'complete' ? 'success' : 'pending'}'
