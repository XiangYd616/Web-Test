...
import React, { useCallback, useMemo, useState    } from 'react';import { Bar, BarChart, CartesianGrid, Cell, Legend, Line, LineChart, Pie, PieChart, PolarAngleAxis, PolarGrid, PolarRadiusAxis, Radar, RadarChart, ResponsiveContainer, Tooltip, XAxis, // YAxis   } from 'recharts';// 已修复'
...
const TestResults: React.FC<TestResultsProps>  = ({
  ...
  return (<div className= 'space-y-6'>
      ...
      {/* 图表视图 */}
      {viewMode === 'chart' && (<div className= 'bg-gray-800 rounded-lg p-6 border border-gray-700'>
      ...
      {/* 结果列表 */}
      {viewMode !== 'chart" && (<div className={`grid gap-4 ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>`
