...
import React, { useState    } from 'react';import { TestResult, TestType    } from '../../types/testConfig';interface TestResultComparisonProps   {'
  testType: TestType;
  results: TestResult[];
  onClose?: () => void;
}
      ...
      <div className= 'bg-white rounded-lg max-w-7xl w-full mx-4 max-h-[90vh] overflow-hidden'>
        ...
        <div className= 'overflow-y-auto max-h-[calc(90vh-120px)]'>
          ...
          <div className= "p-6'>`
            ...
            {getAllCheckNames().length > 0 ? (<div className= 'overflow-x-auto'>
          ...
          {/* 统计信息对比 */}
          {results.some(r => r.summary.totalChecks) && (<div className= 'p-6 border-t border-gray-200'>
