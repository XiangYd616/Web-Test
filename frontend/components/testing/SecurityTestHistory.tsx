...
import { Calendar, ChevronDown, ChevronRight, Clock, Eye, RefreshCw, Search, Shield, Trash2, TrendingDown, TrendingUp    } from 'lucide-react';import React, { useEffect, useState    } from 'react';import { SecurityTestResult    } from '../../services/testing/securityTestService';interface SecurityTestHistoryProps   {
  ...
  return (
    <div className= 'security-test-history space-y-4'>
      ...
      <div className= 'space-y-4'>
        {filteredHistory.length === 0 ? (<div className= 'text-center py-12 bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50'>
