import { AlertTriangle, CheckCircle, FileText, Info, Link, Search, XCircle    } from 'lucide-react';import React from 'react';import { TechnicalSEOResult    } from '../../services/testing/seoTestService';interface TechnicalResultsProps   {'
