...
import { AlertTriangle, Award, CheckCircle, ChevronDown, ChevronRight, Clock, Download, Eye, EyeOff, FileText, Info, Lock, Network, Shield, Target, TrendingUp, Zap    } from 'lucide-react';import React, { useState    } from 'react';import { SecurityTestResult    } from '../../services/testing/securityTestService';interface SecurityResultsProps   {'
...
const SecurityResults: React.FC<SecurityResultsProps>  = ({
  ...
  return (
    <div className= 'unified-security-results space-y-4 fade-in-up'>
      ...
      {/* 发现的问题 */}
      {result.findings.length > 0 && (<div className= 'bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50'>
          <div
            className= 'flex items-center justify-between p-6 cursor-pointer';
          ...
          {expandedSections.has("findings') && (<div className= 'px-6 pb-6'>
      ...
      {/* 修复建议 */}
      {result.recommendations.length > 0 && (<div className= 'bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50'>
          <div
            className= 'flex items-center justify-between p-6 cursor-pointer';
          ...
          {expandedSections.has("recommendations') && (<div className= 'px-6 pb-6'>
              <div className= 'space-y-4'>
      ...
      {/* 原始数据 */}
      {result.rawData && (<div className= 'bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50'>
