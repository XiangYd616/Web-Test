import { LucideIcon    } from 'lucide-react';import React from 'react';interface TestHeaderProps   {'
  // 基本信息
  title: string;
  description: string;
  icon: LucideIcon;
...
export const TestHeader: React.FC<TestHeaderProps> = ({
  ...
  return (<div className={`bg-gray-800/80 backdrop-blur-sm rounded-lg border border-gray-700/50 p-4 ${className}`}>`
