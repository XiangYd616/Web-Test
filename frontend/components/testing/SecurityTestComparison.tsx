...
import { ArrowDown, ArrowUp, Calendar, ChevronDown, ChevronRight, Minus, Shield, TrendingDown, TrendingUp, X    } from 'lucide-react';import React, { useState    } from 'react';import { SecurityTestResult    } from '../../services/testing/securityTestService';interface SecurityTestComparisonProps   {'
...
const SecurityTestComparison: React.FC<SecurityTestComparisonProps>  = ({
  ...
  return (<div className= 'space-y-4'>
        ...
        {expandedSections.has("findings') && (<div className= 'px-6 pb-6'>
            ...
            <div className= 'grid grid-cols-2 md:grid-cols-4 gap-4 mb-6'>
              {['critical', 'high', 'medium', 'low'].map((severity) => {'
                ...
                return (<div key={severity} className= 'bg-gray-700/30 rounded-lg p-3 text-center'>
            ...
            {/* 新增和解决的问题 */}
            {results.length >= 2 && (<div className= 'grid md:grid-cols-2 gap-4'>
                {/* 新增问题 */}
      ...
      <div className= 'bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50'>
        ...
        {expandedSections.has("trends') && (<div className= 'px-6 pb-6'>
