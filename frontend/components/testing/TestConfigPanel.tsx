...
import React, { useState, useEffect    } from 'react';import { TestConfig, TestType, APITestConfig, PerformanceTestConfig    } from '../../types/testConfig';interface TestConfigPanelProps   {'
  testType: TestType;
...
export const TestConfigPanel: React.FC<TestConfigPanelProps> = ({
  ...
  const renderAPIConfig = () => {
    ...
    return (<div className= 'space-y-4'>
        ...
        {(apiConfig.method === 'POST' || apiConfig.method === 'PUT') && (<div>
            <label className= 'block text-sm font-medium text-gray-700 mb-2'>
              请求体
            </label>
            <textarea
        ...
        <div>
          ...
          <div className= 'space-y-2'>
            ...
            {apiConfig.auth?.type === 'bearer' && (<input'
                type= 'text';
            ...
            {apiConfig.auth?.type === 'basic' && (<div className= 'grid grid-cols-2 gap-2'>
                <input
                  type= 'text';
            ...
            {apiConfig.auth?.type === 'apikey' && (<div className= 'grid grid-cols-2 gap-2'>
                <input
                  type= 'text';
  ...
  return (
    <div className= 'bg-white p-6 rounded-lg shadow-sm border'>
      ...
      {errors.length > 0 && (<div className= 'mt-4 p-3 bg-red-50 border border-red-200 rounded-md'>
