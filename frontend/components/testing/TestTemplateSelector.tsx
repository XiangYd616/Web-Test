import { Bookmark, BookmarkCheck, Clock, Plus, Search, Star, Tag, TrendingUp    } from 'lucide-react';import React, { useEffect, useState    } from 'react';import { TestTemplate, TestTemplateService    } from '../../services/testing/testTemplateService';export interface TestTemplateSelectorProps     {'
...
const TestTemplateSelector: React.FC<TestTemplateSelectorProps>  = ({
  ...
  const toggleFavorite = (templateId: string) => {
    const newFavorites = favorites.includes(templateId)
      ? favorites.filter(id => id !== templateId): [...favorites, templateId];
