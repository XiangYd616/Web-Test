...
import React, { useState, useEffect    } from 'react';import { Settings, Users, Clock, Zap, Shield, Globe, Database, TrendingUp, AlertTriangle, Info, ChevronDown, // ChevronUp   } from 'lucide-react';// 已修复'
...
const StressTestConfig: React.FC<StressTestConfigProps>  = ({
  ...
  return (<div className={`bg-white rounded-lg border border-gray-200 ${className}`}>`
      ...
      <div className= 'p-4'>
        ...
        {/* 基础配置 */}
        {(!showAdvanced || activeTab === "basic') && (<div className= 'space-y-4'>`
            {/* 测试类型选择 */}
            <div>
