import { AlertTriangle, CheckCircle, Info, Lightbulb, TrendingUp, XCircle, Zap    } from 'lucide-react';import React from 'react';import { PerformanceResult    } from '../../services/testing/seoTestService';interface PerformanceResultsProps   {'
...
const PerformanceResults: React.FC<PerformanceResultsProps>  = ({ results }) => {
  ...
  return (
    <div className= "space-y-6'>`
      ...
      {/* 问题列表 */}
      {results.issues && results.issues.length > 0 && (<div className= 'bg-gray-800/50 rounded-lg p-6 border border-gray-700/50'>
          <h3 className= 'text-lg font-semibold text-white mb-4 flex items-center'>
