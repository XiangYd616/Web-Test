import React, { useState, useEffect    } from 'react';import { Plus, Trash2, Copy, Upload, Play    } from 'lucide-react';interface APIEndpoint   {'
  id: string;
  name: string;
        ...
        <div className= 'space-y-4'>
          {endpoints.map((endpoint) => (
            <div key={endpoint.id} className= 'border border-gray-200 dark:border-gray-600 rounded-lg p-4'>
              ...
              {endpoint.description !== undefined && (<textarea
