import { AlertCircle, AlertTriangle, BarChart3, CheckCircle, Download, ExternalLink, FileText, Globe, Hash, Info, Lightbulb, Shield, Smartphone, TrendingUp, Type, Users, XCircle, Zap    } from 'lucide-react';import React, { useState    } from 'react';import { useTheme    } from '../../contexts/ThemeContext';import PerformanceResults from './PerformanceResults';import TechnicalResults from './TechnicalResults';interface SEOResults   {'
  id: string;
  url: string;
  timestamp: string;
  status: string;
      ...
      <div className= 'space-y-6'>
        ...
        <div className= 'bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700'>
          ...
          <div className= 'space-y-4'>
            ...
            {contentQuality.headings.h1Content.length > 0 && (<div className= 'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded p-4'>
            ...
            {contentQuality.headings.issues.length > 0 && (<div className= 'space-y-3 mt-4'>
                <p className= 'text-sm font-semibold text-orange-600 dark:text-orange-400'>优化建议：</p>
                <ul className= 'space-y-2'>
  ...
  const renderIssuesAndSuggestions = () => {
    ...
    return (
      <div className= 'space-y-6'>
        ...
        {/* 问题列表 */}
        {sortedIssues.length > 0 && (<div className= 'bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700'>
            <div className= 'flex items-center space-x-3 mb-4'>
        ...
        {/* 优化建议 */}
        {allRecommendations.length > 0 && (<div className= 'bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700'>
            <div className= 'flex items-center space-x-3 mb-4'>
