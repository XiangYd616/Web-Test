import React, { useEffect, useState    } from 'react';import { AlertTriangle, CheckCircle, Code, Globe, RefreshCw, Shield, XCircle, Zap    } from 'lucide-react';interface EngineStatus   {'
  name: string;
