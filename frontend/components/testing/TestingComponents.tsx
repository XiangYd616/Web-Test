import { AlertTriangle, CheckCircle, Clock, Download, Loader, Play, RotateCcw, Square, XCircle    } from 'lucide-react';import React from 'react';// 统一的测试状态类型'
export type TestStatus   = 'idle' | 'starting' | 'running' | 'completed' | 'failed' | "stopped';// 统一的测试配置接口'
...
export const TestResultOverview: React.FC<TestResultOverviewProps> = ({
  ...
  return (<div className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6 mb-6'>
