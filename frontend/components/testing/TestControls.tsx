...
import { AlertCircle, CheckCircle, Loader, Play, RotateCcw, Square, XCircle    } from 'lucide-react';import React from 'react';import { TestPhase, TestState    } from '../../services/testing/testStateManager';// 控制组件属性接口'
      ...
      <div className= 'flex flex-col lg:flex-row lg:items-center justify-between gap-4'>
        ...
        <div className= 'flex items-center space-x-4'>
          ...
          <div className={`flex items-center space-x-3 px-4 py-2 rounded-lg border ${config.bgColor} ${config.borderColor}`}>`
            <IconComponent className={`w-5 h-5 ${config.color} ${testState === TestState.STARTING || testState === TestState.RUNNING ? 'animate-pulse" : "'}`}'`
               />
            <div>
