...
import React, { ReactNode    } from 'react';import { Navigate, useLocation    } from 'react-router-dom';import { useAuth    } from '../../contexts/AuthContext';import Loading from '../ui/Loading';interface AuthGuardProps   {'
  children: ReactNode;
  requireAuth?: boolean;
  redirectTo?: string;
  fallback?: ReactNode;
