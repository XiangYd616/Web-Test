import React, { useState    } from 'react';import { Lock, Eye, EyeOff, Shield, Star    } from 'lucide-react';import { useAuth    } from '../../contexts/AuthContext';import LoginPrompt from './LoginPrompt';interface ProtectedFeatureProps   {'
...
const ProtectedFeature: React.FC<ProtectedFeatureProps>  = ({
  ...
  return (<div className={`relative ${className}`}>`
      ...
      {/* 无预览模式 */}
      {!showPreview && (<div className= 'bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-8 text-center'>
          <div className= 'inline-flex items-center justify-center w-16 h-16 bg-blue-600/20 rounded-full mb-4'>
