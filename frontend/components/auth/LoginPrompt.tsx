import React from 'react';import { useNavigate     } from 'react-router-dom';import { Lock, ArrowRight, Shield, Star, X, LogIn     } from 'lucide-react';interface LoginPromptProps   {
  isOpen: boolean;,
  onClose: () => void;
  feature?: string;
  description?: string;
