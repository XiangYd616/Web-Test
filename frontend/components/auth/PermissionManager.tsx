...
import { AlertTriangle, Check, ChevronDown, ChevronRight, Edit, Info, Key, Plus, Search, Shield, Trash2, Users, X    } from 'lucide-react';import React, { useEffect, useMemo, useState    } from 'react';import type { Permission, Role, UserPermissions  } from '../../services/auth/rbacService';import { useRBAC    } from '../../services/auth/rbacService';// ==================== 类型定义 ==================== ''
  ...
  return (
    <div className= 'space-y-2'>
      {Object.entries(permissionsByCategory).map(([category, categoryPermissions]) => {
        ...
        return (<div key={category} className= 'border border-gray-600 rounded-lg'>
            <button
