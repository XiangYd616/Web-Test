...
import { Activity, AlertTriangle, BarChart3, CheckCircle, LineChart, RefreshCw, Target, TrendingDown, TrendingUp, Zap    } from 'lucide-react';import React, { useEffect, useState    } from 'react';// 暂时注释掉缺失的导入'
...
import { Bar, BarChart, CartesianGrid, Line, LineChart as RechartsLineChart, ResponsiveContainer, Tooltip, XAxis, YAxis    } from 'recharts';interface AnalyticsProps   {'
        ...
        <div className= 'space-y-6'>
          ...
          <div className= 'grid grid-cols-1 md:grid-cols-3 gap-6'>
            ...
            <div className= 'bg-gray-700 rounded-lg p-4'>
              ...
              <div className= 'space-y-2'>
                {insights.alerts.length > 0 ? (insights.alerts.map((alert: string, index: number) => (
                    <div
                      key={index}
