...
import React, { useState, useEffect    } from 'react';import { Shield, AlertTriangle, CheckCircle, XCircle, Lock, Unlock, Eye, EyeOff, Bug, Zap, Target, FileText, Download, // RefreshCw   } from 'lucide-react';// 已修复'
import { createApiUrl    } from '../../config/api';interface SecurityVulnerability   {'
  type: string;
      ...
      {result && (
        <div className= 'space-y-6'>
          ...
          <div className= 'bg-gray-700 rounded-lg p-4'>
            ...
            {activeTab === 'vulnerabilities' && (<div className= 'space-y-4'>
            ...
            {activeTab === 'ssl' && (<div className= 'space-y-4'>
