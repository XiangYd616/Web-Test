import { handleAsyncError    } from '../utils/errorHandler';import React, { useState    } from 'react';import { Play, GitBranch, CheckCircle, XCircle, Clock, Code    } from 'lucide-react';export interface CICDDemoProps     {'
  // 基础属性
  className?: string;
...
const CICDDemo: React.FC<CICDDemoProps>  = (props) => {
        ...
        <div className= 'space-y-4'>
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* 日志输出 */}
              {step.logs && (<div className= 'mt-3 p-3 bg-gray-900 rounded text-green-400 font-mono text-sm'>
