import React, { useState    } from 'react';import { Search, Filter, RefreshCw, ChevronDown, ChevronUp, X, Database, Globe, Zap, Shield, Code, Eye, Wifi, FileText    } from 'lucide-react';interface QueryFilters   {'
  testType: string;
  status: string;
  dateRange: string;
