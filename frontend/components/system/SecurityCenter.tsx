import React, { useState    } from 'react';import { Activity, AlertTriangle, Eye, EyeOff, Key, Lock, Shield, Users    } from 'lucide-react';export interface SecurityCenterProps     { 
  // 基础属性
  className?: string;
...
const SecurityCenter: React.FC<SecurityCenterProps>  = (props) => { const memoizedHandleClick = useCallback((event: React.MouseEvent<HTMLElement>) => {
  ...
  const getEventTypeIcon = (type: string) => { switch (type) {
  ...
  const getEventTypeLabel = (type: string) => { switch (type) {
  ...
  return (<div className= 'space-y-6'>;
      ...
      <div className= 'grid grid-cols-1 lg:grid-cols-2 gap-6'>;
        ...
        <div className= 'bg-white rounded-lg shadow-sm p-6'>;
          ...
          {showPasswordPolicy && (<div className= 'space-y-4'>
              <div>;
