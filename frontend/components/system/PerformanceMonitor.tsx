...
import React, { useState    } from 'react';import { useDevicePerformance, useMemoryMonitor, useNetworkStatus, usePerformanceMonitor, // useVisibility   } from '../../hooks/usePerformanceOptimization';// 已修复'
...
const PerformanceMonitor: React.FC<PerformanceMonitorProps>  = ({
  ...
  const ariaProps = {
    ...
    return (<div className={`fixed bottom-4 right-4 z-50 ${className}`}>`
            ...
            {/* 详细视图 */}
            {isExpanded && (<div className= 'bg-black bg-opacity-90 text-white p-4 rounded-lg max-w-md max-h-96 overflow-y-auto'>
