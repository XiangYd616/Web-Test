import React, { useEffect, useState    } from 'react';import { Activity, AlertTriangle, BarChart3, Server, TestTube, Users    } from 'lucide-react';import { useNotifications    } from '../ui/NotificationSystem';import SystemHealthCheck from './SystemHealthCheck';export interface SystemStatusDashboardProps     {'
  // 基础属性
  className?: string;
...
const SystemStatusDashboard: React.FC<SystemStatusDashboardProps>  = (props) => {
        ...
        <div className= 'grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <div className= "bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6'>`
            ...
            <div className= 'space-y-3'>
              {alerts.length === 0 ? (<p className= 'text-gray-400 text-center py-4'>暂无系统警告</p>
              ): (alerts.map((alert)  => (
                  <div
                    key={alert.id}
