import React from 'react';import { useNavigate    } from 'react-router-dom';import { X, ExternalLink    } from 'lucide-react';import { useNotifications    } from '../../hooks/useNotifications';export interface BackgroundTestNotificationsProps     { 
  // 基础属性
  className?: string;
...
const BackgroundTestNotifications: React.FC<BackgroundTestNotificationsProps>  = (props) => {
        ...
        >;
          <div className= "flex items-start justify-between'>`;'"`
            <div className= 'flex-1 min-w-0'>;
              ...
              {notification.actionUrl && notification.actionText && (<button>
                  type= 'button'
                  onClick={() => {
