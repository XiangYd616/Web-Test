import { Activity, AlertTriangle, Bell, CheckCircle, Clock, Edit, Eye, EyeOff, Globe, Pause, Play, Plus, Trash2, TrendingUp, Zap    } from 'lucide-react';import React, { useEffect, useState    } from 'react';interface MonitoringTarget   {'
  id: string;
  name: string;
  url: string;
  ...
  return (<div className={`space-y-6 ${className}`}>`
      ...
      <div className= 'bg-white rounded-xl shadow-sm border border-gray-100'>
        ...
        <div className= 'divide-y divide-gray-200'>
          {targets.length === 0 ? (<div className= 'p-8 text-center'>
