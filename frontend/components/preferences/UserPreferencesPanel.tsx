...
import React, { useEffect, useState    } from 'react';// 暂时注释掉缺失的导入'
// import { //   userPreferencesService, //   UserPreferences, //   PreferenceCategory, //   PreferenceSetting
//   } from '../../services/preferences/userPreferencesService';interface UserPreferencesPanelProps   {'
  onClose?: () => void;
}
  ...
  return (
    <div className= 'fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
      <div className= 'bg-gray-800 rounded-lg border border-gray-700 w-full max-w-6xl max-h-[90vh] overflow-hidden'>
        ...
        {/* 底部状态栏 */}
        {hasChanges && (<div className= 'px-6 py-3 bg-yellow-500/10 border-t border-gray-700 flex items-center justify-between'>
