...
const ServicesTestEngine = require('../engines/services/ServicesTestEngine');

const engine = new ServicesTestEngine();
...
router.post('/run', async (req, res) => {
  try {
    const result = await engine.runServicesTest(req.body);
    res.json(result);
  } catch (error) {
