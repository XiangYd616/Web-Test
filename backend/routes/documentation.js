...
const DocumentationTestEngine = require('../engines/documentation/DocumentationTestEngine');

const engine = new DocumentationTestEngine();
...
router.post('/run', async (req, res) => {
  try {
    const result = await engine.runDocumentationTest(req.body);
    res.json(result);
  } catch (error) {
