 ...
 */
router.post('/create-and-start', authMiddleware, asyncHandler(testController.createAndStart));

// ==================== 测试类型快捷路由 ====================

router.post('/website', authMiddleware, asyncHandler(testController.createWebsiteTest));
router.post('/performance', authMiddleware, asyncHandler(testController.createPerformanceTest));
router.post('/security', authMiddleware, asyncHandler(testController.createSecurityTest));
router.post('/seo', authMiddleware, asyncHandler(testController.createSEOTest));
router.post('/stress', authMiddleware, asyncHandler(testController.createStressTest));
router.post('/api', authMiddleware, asyncHandler(testController.createAPITest));
router.post('/accessibility', authMiddleware, asyncHandler(testController.createAccessibilityTest));
router.post('/compatibility', authMiddleware, asyncHandler(testController.createCompatibilityTest));
router.post('/ux', authMiddleware, asyncHandler(testController.createUXTest));
 ...
 */
router.post('/:testId/rerun', authMiddleware, asyncHandler(testController.rerunTest));

/**
 * 批量创建测试
 * POST /api/test/batch
 */
router.post('/batch', authMiddleware, asyncHandler(testController.createBatchTests));
