...
const { getConnectionManager } = database as unknown as {
  getConnectionManager: () => Promise<ConnectionManager>;
};
...
class DatabasePerformanceOptimizer {
  ...
  async createOptimalIndexes() {
    const indexes: IndexConfig[] = [
      ...
      {
        name: 'idx_test_executions_user_id',
      ...
      {
        name: 'idx_test_executions_engine_type',
        table: 'test_executions',
        columns: ['engine_type'],
        unique: false,
        condition: null,
      ...
      {
        name: 'idx_test_executions_status',
        table: 'test_executions',
        columns: ['status'],
        unique: false,
        condition: null,
      ...
      {
        name: 'idx_test_executions_created_at',
        table: 'test_executions',
        columns: ['created_at'],
        unique: false,
        condition: null,
      ...
      {
        name: 'idx_test_executions_test_url',
        table: 'test_executions',
        columns: ['test_url'],
        unique: false,
        condition: null,
