...
export { ApiSecurity, apiSecurity, apiSecurity as default, apiSecurity as securityMiddleware };

export const basicSecurity = apiSecurity.basicSecurity.bind(apiSecurity);
export const corsMiddleware = apiSecurity.corsMiddleware.bind(apiSecurity);
export const inputValidation = apiSecurity.inputValidation.bind(apiSecurity);
export const sqlInjectionProtection = apiSecurity.sqlInjectionProtection.bind(apiSecurity);
export const xssProtection = apiSecurity.xssProtection.bind(apiSecurity);
export const getRateLimiter = apiSecurity.getRateLimiter.bind(apiSecurity);
export const requestSizeLimit = apiSecurity.requestSizeLimit.bind(apiSecurity);
export const securityHeaders = apiSecurity.securityHeaders.bind(apiSecurity);
export const comprehensiveSecurity = apiSecurity.comprehensiveSecurity.bind(apiSecurity);
