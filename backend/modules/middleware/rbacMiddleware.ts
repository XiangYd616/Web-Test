...
async function checkResourceOwnership(
  ...
  try {
    const ownershipChecker = rbacService as unknown as {
    ...
    if (!ownershipChecker.checkResourceOwnership) {
      return false;
    }
    return await ownershipChecker.checkResourceOwnership(userId, resourceType, resourceId);
  } catch (error) {
