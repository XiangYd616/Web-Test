...
import { UnifiedTestHeader } from './UnifiedTestHeader';

interface UnifiedTestPageLayoutProps {
  // 页面基本信息
...
export const UnifiedTestPageLayout: React.FC<UnifiedTestPageLayoutProps> = ({
  testType,
  title,
  description,
  icon,
