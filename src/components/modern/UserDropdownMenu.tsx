...
const UserDropdownMenu: React.FC<UserDropdownMenuProps> = ({ onClose }) => {
  ...
  return (
    <div className={`absolute right-0 top-full mt-2 w-72 rounded-xl shadow-2xl z-[9999] border backdrop-blur-sm ${
      actualTheme === 'light'
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center space-x-1 mt-1">
              ...
              <span className={`text-xs ${
                actualTheme === 'light' ? 'text-green-600' : 'text-green-400'
              }`}>
                在线
              </span>
            </div>
      ...
      <div className={`px-4 py-3 border-b ${
        actualTheme === 'light' ? 'border-gray-200 bg-gray-50/50' : 'border-gray-700 bg-gray-700/30'
      }`}>
        {statsLoading ? (
          <div className="grid grid-cols-3 gap-3 text-center">
            {[1, 2, 3].map((i) => (
              <div key={i} className="animate-pulse">
                <div className={`h-6 w-8 mx-auto mb-1 rounded ${
                  actualTheme === 'light' ? 'bg-gray-200' : 'bg-gray-600'
                }`}></div>
      ...
      <div className="p-2">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className={`text-xs ${
              actualTheme === 'light' ? 'text-gray-500' : 'text-gray-500'
            }`}>
              查看和编辑个人信息
            </p>
          </div>
      ...
      <div className={`p-2 border-t ${
        ...
        <div className={`flex items-center justify-between px-3 py-2.5 rounded-lg ${
          actualTheme === 'light' ? 'bg-gray-50' : 'bg-gray-700/30'
        }`}>
          <div className="flex items-center space-x-3">
      ...
      <div className={`p-2 border-t ${
        ...
        <button
          ...
          className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-200 w-full group ${
            actualTheme === 'light'
        ...
        >
          ...
          <div className="flex-1 text-left">
            ...
            <p className={`text-xs ${
              actualTheme === 'light' ? 'text-red-500' : 'text-red-500'
            }`}>
              安全退出当前账户
            </p>
          </div>
      ...
      <div className={`px-4 py-2 border-t text-center ${
        ...
        <p className={`text-xs ${
          actualTheme === 'light' ? 'text-gray-400' : 'text-gray-600'
        }`}>
          © 2024 专业测试平台
        </p>
      </div>
