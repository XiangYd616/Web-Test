import localTestLogRepository from './localTestLogRepository';
...
export const insertExecutionLog = async (
  ...
  await localTestLogRepository.insertExecutionLog(testId, normalizedLevel, message, context);
  await localTestOperationsRepository.insertOperationLog(testId, 'log', message, context);
};
...
export const updateStatusWithLog = async (
  ...
  await localTestOperationsRepository.updateStatus(testId, status);
...
export const markFailedWithLog = async (
  ...
  await localTestOperationsRepository.markFailed(testId, errorMessage);
...
export const markCompletedWithLog = async (
  ...
  await localTestOperationsRepository.markCompleted(testId, executionTimeSeconds);
...
export const markStartedWithLog = async (
  ...
  await localTestOperationsRepository.markStarted(testId);
...
export const getLogsByTraceId = async (
  ...
  return localTestLogRepository.getLogsByTraceId(traceId, options);
};
...
export const countDeadLetterReplays = async (
  ...
  return localTestLogRepository.countDeadLetterReplays(testId, options.deadLetterJobId);
};
