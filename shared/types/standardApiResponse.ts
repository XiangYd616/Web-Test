...
export enum StandardErrorCode {
  ...
  TEST_DEPENDENCY_MISSING = 'TEST_DEPENDENCY_MISSING',
}
...
export const StandardStatusCodeMap: Record<StandardErrorCode, HttpStatusCode> = {
  ...
  [StandardErrorCode.TEST_EXECUTION_ERROR]: 500,
  [StandardErrorCode.TEST_CONFIGURATION_ERROR]: 400,
  [StandardErrorCode.TEST_TIMEOUT]: 504,
  [StandardErrorCode.TEST_NOT_FOUND]: 404,
  [StandardErrorCode.TEST_ALREADY_RUNNING]: 409,
  [StandardErrorCode.TEST_INVALID_TYPE]: 400,
  [StandardErrorCode.TEST_DEPENDENCY_MISSING]: 503,
};
...
export const StandardErrorMessages: Record<StandardErrorCode, string> = {
  ...
  [StandardErrorCode.TEST_INVALID_TYPE]: '测试类型不受支持',
  [StandardErrorCode.TEST_DEPENDENCY_MISSING]: '测试依赖缺失',
};
